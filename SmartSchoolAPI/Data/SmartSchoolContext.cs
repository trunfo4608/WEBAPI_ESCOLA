        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1,1, "Lauro","Oliveira","333333333333"),
                    new Professor(2,2, "Roberto","Carvalho","1111111111"),
                    new Professor(3,3, "Ronaldo","Marconi","11111111111"),
                    new Professor(4,4, "Rodrigo","Pinto","22222222222"),
                    new Professor(5,5, "Alexandre","Seixas","99999999999"),
                });

            builder.Entity<Curso>()
                .HasData(new List<Curso>
                {
                      new Curso(1,"Tecnolia Informacao"),
                      new Curso(2,"Sistema Informacao"),
